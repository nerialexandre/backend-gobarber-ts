...
var CreateUserTokenService_1 = __importDefault(require("./password/CreateUserTokenService"));
var CreateUserService = /** @class */ (function () {
    ...
    CreateUserService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var userRepository, checkAvailability, hashadPassword, user, userId;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        hashadPassword = _b.sent();
                        return [4 /*yield*/, userRepository.create(name, email, hashadPassword)];
                    case 3:
                        user = _b.sent();
                        userId = user.id;
                        return [4 /*yield*/, CreateUserTokenService_1.default.execute({
                                userId: userId
                            })];
                    case 4:
                        _b.sent();
