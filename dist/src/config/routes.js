...
exports.default = (function (app) {
    ...
    function getFiles(dir, files_, fileType) {
        ...
        return fs_1.readdirSync(dir).reduce(function (allFiles, file) {
            var name = path_1.default.join(dir, file);
    ...
    var allFiles = getFiles(__dirname + "/../routes", [], '.ts|.js');
    allFiles.map(function (file) { return __awaiter(void 0, void 0, void 0, function () {
