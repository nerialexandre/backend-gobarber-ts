...
var UserRepository = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        findUser = _a.sent();
                        return [2 /*return*/, findUser || null];
                }
            });
        });
    };
    UserRepository.prototype.create = function (name, email, password) {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.ormRepository.create({ name: name, email: email, password: password })];
                    case 1:
                        user = _a.sent();
    ...
    UserRepository.prototype.updatePassword = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.ormRepository.findOne(data.userId)];
                    case 1:
                        user = _a.sent();
                        if (!user) {
    ...
    UserRepository.prototype.updateProfile = function (id, name, email) {
        return __awaiter(this, void 0, void 0, function () {
            var user;
            return __generator(this, function (_a) {
                switch (_a.label) {
