...
var RegisterNewPasswordService = /** @class */ (function () {
    ...
    RegisterNewPasswordService.prototype.execute = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var userRepository, userTokenRepository, id, oldPassword, newPassword, findUser, checkPassword, hashadPassword, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        userRepository = new UserRepository_1.default();
                        userTokenRepository = new UserTokenRepository_1.default();
                        id = data.id, oldPassword = data.oldPassword, newPassword = data.newPassword;
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, bcryptjs_1.compare(oldPassword, findUser.password)];
                    case 2:
                        checkPassword = _a.sent();
                        if (!checkPassword) {
                            throw new Error('senha anterior invalida');
                        }
                        return [4 /*yield*/, userTokenRepository.delete(id)];
                    case 3:
                        _a.sent();
